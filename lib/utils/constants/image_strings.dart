...
class TImages {
  ...
  // -- App Logos
  static const String darkAppLogo = "assets/logos/icon.png"; //t-store-splash-logo-black.png
  static const String lightAppLogo = "assets/logos/icon.png"; //t-store-splash-logo-white.png
